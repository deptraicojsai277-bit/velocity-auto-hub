  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-body tracking-wide",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-to-r from-primary to-primary/80 text-primary-foreground font-display uppercase tracking-wider hover:shadow-glow hover:scale-105 border border-primary/20",
        heroOutline: "bg-transparent border-2 border-foreground/30 text-foreground font-display uppercase tracking-wider hover:bg-foreground/10 hover:border-foreground/50 hover:scale-105",
        glow: "bg-primary text-primary-foreground shadow-glow hover:shadow-[0_0_60px_hsl(0_85%_55%/0.5)] hover:scale-105",
      },
      size: {
